...
{
    public partial class TicketLinesController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TicketLinesController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected TicketLinesController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TicketLinesController Actions { get { return MVC.TicketLines; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "TicketLines";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "TicketLines";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/TicketLines/Create.cshtml";
            public readonly string Delete = "~/Views/TicketLines/Delete.cshtml";
            public readonly string Details = "~/Views/TicketLines/Details.cshtml";
            public readonly string Edit = "~/Views/TicketLines/Edit.cshtml";
            public readonly string Index = "~/Views/TicketLines/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TicketLinesController : Betting.Controllers.TicketLinesController
    {
        public T4MVC_TicketLinesController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int ticketId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(int ticketId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "ticketId", ticketId);
            CreateOverride(callInfo, ticketId);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Betting.ViewModels.Tickets.EditTicketLineViewModel viewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Betting.ViewModels.Tickets.EditTicketLineViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
